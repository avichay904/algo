...
import { DISABLE_GIST } from 'common/env';
    ...
    return (
      <nav className={classes(styles.navigator, className)}>
        <div className={styles.search_bar_container}>
          ...
          <input type="text" className={styles.search_bar} aria-label={t('navigator.search')} placeholder={t('navigator.search_placeholder')} autoFocus
        ...
        {!DISABLE_GIST && (
          <div className={styles.footer}>
            <ExpandableListItem icon={faCode} label={t('navigator.scratch_paper')} onClick={() => this.toggleScratchPaper()}
            ...
            <ListItem icon={faBook} label={t('navigator.api_reference')}
                      href="https://github.com/algorithm-visualizer/algorithm-visualizer/wiki"/>
            <ListItem icon={faGithub} label={t('navigator.fork_me')}
