  ...
  render() {
    ...
    return (
      <div className={classes(styles.code_editor, className)}>
        <div dir="ltr" style={{ direction: 'ltr' }} className={styles.ace_editor}>
          <FoldableAceEditor
        ...
        <div className={classes(styles.contributors_viewer, className)}>
          <span className={classes(styles.contributor, styles.label)}>{t('editor.contributed_by')}</span>
          {
          ...
          <div className={styles.empty}>
            ...
            <Button className={styles.delete} icon={faTrashAlt} primary confirmNeeded
              ...
              <Ellipsis>{t('editor.delete_file')}</Ellipsis>
            </Button>
          </div>
        </div>
      </div>
